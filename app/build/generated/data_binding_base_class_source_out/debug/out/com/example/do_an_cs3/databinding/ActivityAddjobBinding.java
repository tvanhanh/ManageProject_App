...
public final class ActivityAddjobBinding implements ViewBinding {
  ...
  private ActivityAddjobBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static ActivityAddjobBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityAddjobBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_addjob, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityAddjobBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityAddjobBinding((ConstraintLayout) rootView, bottomnavigation, btnback,
