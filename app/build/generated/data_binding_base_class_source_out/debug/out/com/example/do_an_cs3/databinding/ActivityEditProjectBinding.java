...
public final class ActivityEditProjectBinding implements ViewBinding {
  ...
  @NonNull
  public final Button buttonThenext;
  ...
  private ActivityEditProjectBinding(@NonNull ConstraintLayout rootView, @NonNull Button btnback,
      @NonNull Button buttonHome, @NonNull Button buttonThenext, @NonNull Button buttonaddPerson,
    ...
    this.buttonThenext = buttonThenext;
  ...
  public static ActivityEditProjectBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.buttonThenext;
      Button buttonThenext = ViewBindings.findChildViewById(rootView, id);
      if (buttonThenext == null) {
        break missingId;
      }
      ...
      return new ActivityEditProjectBinding((ConstraintLayout) rootView, btnback, buttonHome,
          buttonThenext, buttonaddPerson, buttonaddTime, buttondatejob, editAddNameProject,
          linearLayout, logo, textInputEditTextDescription, textView3, textViewDate);
    }
