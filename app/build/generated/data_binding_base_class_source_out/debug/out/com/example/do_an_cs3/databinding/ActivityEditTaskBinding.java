...
public final class ActivityEditTaskBinding implements ViewBinding {
  ...
  @NonNull
  public final EditText editNameJob;
  ...
  private ActivityEditTaskBinding(@NonNull ConstraintLayout rootView, @NonNull Button btnback,
      @NonNull Button butonThenext, @NonNull Button buttonHome, @NonNull Button buttonaddTime,
      @NonNull Button buttondatejob, @NonNull EditText editNameJob,
  ...
  public static ActivityEditTaskBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.editNameJob;
      EditText editNameJob = ViewBindings.findChildViewById(rootView, id);
      if (editNameJob == null) {
        break missingId;
      }
      ...
      return new ActivityEditTaskBinding((ConstraintLayout) rootView, btnback, butonThenext,
          buttonHome, buttonaddTime, buttondatejob, editNameJob, linearLayout, logo,
