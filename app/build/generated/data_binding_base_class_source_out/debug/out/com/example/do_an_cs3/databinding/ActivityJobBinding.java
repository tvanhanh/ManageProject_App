...
public final class ActivityJobBinding implements ViewBinding {
  ...
  public static ActivityJobBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityJobBinding((ConstraintLayout) rootView, bottomnavigation, buttonComback,
          buttonDate, buttonSeacrh, buttonWarning, linearLayout, logo, tabLayout, viewpager);
    }
