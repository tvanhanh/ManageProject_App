...
public final class ActivityProjectBinding implements ViewBinding {
  ...
  private ActivityProjectBinding(@NonNull ConstraintLayout rootView,
      ...
      @NonNull LinearLayout linearLayout, @NonNull TabLayout tabLayout,
  ...
  public static ActivityProjectBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityProjectBinding((ConstraintLayout) rootView, bottomnavigation,
          buttonComback, buttonDate, buttonSeacrh, buttonWarning, linearLayout, tabLayout,
          viewpager);
    }
